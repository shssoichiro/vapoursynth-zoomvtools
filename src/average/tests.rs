...
macro_rules! average2_tests {
    ($module:ident) => {
        paste! {
            #[test]
            fn [<average2_u8_basic_ $module>]() {
                let src1 = [0u8, 2, 4, 6];
                let src2 = [1u8, 3, 5, 7];
                let mut dest = [0u8; 4];

                verify_asm!($module, average2(
                    &mut dest,
                    &src1,
                    &src2,
            ...
            #[test]
            fn [<average2_u8_ceiling_division_ $module>]() {
                let src1 = [0u8, 1, 2, 3];
                let src2 = [1u8, 2, 3, 4];
                let mut dest = [0u8; 4];
            ...
            #[test]
            fn [<average2_u8_max_values_ $module>]() {
            ...
            #[test]
            fn [<average2_u8_zero_values_ $module>]() {
                let src1 = [0u8, 0, 1, 1];
                let src2 = [0u8, 1, 0, 1];
                let mut dest = [0u8; 4];
            ...
            #[test]
            fn [<average2_u16_high_values_ $module>]() {
            ...
            #[test]
            fn [<average2_u16_max_values_ $module>]() {
            ...
            #[test]
            fn [<average2_u8_single_pixel_ $module>]() {
                let src1 = [100u8];
                let src2 = [200u8];
                let mut dest = [0u8; 1];
            ...
            #[test]
            fn [<average2_u8_different_pitch_ $module>]() {
            ...
            #[test]
            fn [<average2_u16_different_pitch_ $module>]() {
            ...
            #[test]
            fn [<average2_u8_rectangular_ $module>]() {
            ...
            #[test]
            fn [<average2_u8_odd_addition_results_ $module>]() {
            ...
            #[test]
            fn [<average2_u16_odd_addition_results_ $module>]() {
